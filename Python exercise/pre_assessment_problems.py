...
#     Blank_Word=""
#     for blk in word:
#         Blank_Word = blk + palindrome_check
#         return Blank_Word == palindrome_check
#         print(palindrome_check("eye"))
...
def convert_distance(miles):
    ...
    print("distance Kilomiters" + str(result))
    print("round-trip Kilomiters" + str(result*2))
...
# def sort_words_alphabetically(Word):
#  word="hi we are learning python and it's awesome"
#  sorting= word.split(' ')
#  sorting.sort()
